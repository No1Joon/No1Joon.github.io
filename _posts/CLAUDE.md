...
- News (AI Daily 등) 네이밍: `_posts/news/YYYY-MM-DD-{series-slug}.md` (예: `2026-05-01-ai-daily.md`). 본문 변경 없이 front matter 만 부착하는 워크플로는 `news-post` 스킬 참조.
...
- `.claude/skills/news-post/SKILL.md` — News 카테고리(AI Daily 등) 일자별 브리핑 그대로 포스트화.
